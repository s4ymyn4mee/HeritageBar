...
Логин: <code>laffpie@mail.ru</code>

Пароль: <code>popochka_muravia</code>
...
TEST_USER_EMAIL=<already_authorized_test_user_email>
...
* написать авто-тесты для бэкенда
* написать UI/E2E авто-тесты
* добавить возможность изменять имя пользователя и пароль
* добавить возможность восстановить пароль по почте
* посмотреть, что за проблемы там с HTTPS
* сделать страницы с ошибками красивее
* тщательно проверить на защиту от SQL-инъекций, XSS-атак, CSRF-атак
