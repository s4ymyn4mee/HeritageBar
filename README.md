...
* [ ] Добавить автоматическую генерацию отчетов Allure
* [ ] Зафиксировать баг-репорты либо в Jira, либо в Github Issues
* [ ] Исправить баги на серваке, сделать ре-тесты
* [ ] Построить CI/CD пайплайн
* [ ] Захостить на Github Pages Allure-отчет, повесить на CI/CD пайплайн
